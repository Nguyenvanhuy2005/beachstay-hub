...
const TestimonialsSection = () => {
  ...
  return (
    <section className="py-20 bg-beach-700 text-white relative">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-beach-100 max-w-3xl mx-auto">
            {isVietnamese 
              ...
              : 'See what guests who have experienced our service say about Annam Village.'}
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            <motion.div
              ...
              className="bg-beach-800/50 backdrop-blur-sm p-8 md:p-10 rounded-xl"
            >
              <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
                <img 
                  src={testimonials[activeIndex].image} 
                  alt={testimonials[activeIndex].name[language]} 
                  className="w-20 h-20 rounded-full object-cover border-4 border-beach-500"
                />
              ...
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all ${
                    index === activeIndex 
                      ? "bg-white scale-125" 
                      : "bg-beach-200/50 hover:bg-beach-200"
                  }`}
            ...
            <div className="absolute top-1/2 -translate-y-1/2 -left-4 md:-left-12">
              <button 
                ...
                className="bg-beach-600 hover:bg-beach-500 text-white p-2 rounded-full transition-all"
