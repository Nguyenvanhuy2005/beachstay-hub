...
const CtaSection = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-r from-olive-700 to-olive-600 text-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-1/3 h-full bg-olive-500/20 -skew-x-12 transform origin-top-right"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                className="bg-white text-olive-700 hover:bg-olive-50 px-8 py-6 text-lg font-medium"
