...
const fallbackRooms = [
  {
    ...
    amenities: [
      ...
      { id: "pool", vi: "Hồ bơi riêng", en: "Private pool" },
      { id: "air_con", vi: "Điều hòa", en: "Air conditioning" },
      { id: "tv", vi: "TV màn hình phẳng", en: "Flat-screen TV" },
      { id: "bath", vi: "Bồn tắm", en: "Bathtub" }
    ],
    is_popular: true
  },
  {
    ...
    amenities: [
      { id: "wifi", vi: "WiFi miễn phí", en: "Free WiFi" },
      { id: "tv", vi: "TV màn hình phẳng", en: "Flat-screen TV" },
      { id: "coffee", vi: "Máy pha cà phê", en: "Coffee maker" },
      { id: "minibar", vi: "Minibar", en: "Minibar" },
      { id: "bath", vi: "Bồn tắm", en: "Bathtub" }
    ],
    is_popular: true
  },
  {
    ...
    amenities: [
      ...
      { id: "bath", vi: "Bồn tắm", en: "Bathtub" },
      { id: "coffee", vi: "Máy pha cà phê", en: "Coffee maker" },
      { id: "private_beach", vi: "Lối ra biển riêng", en: "Private beach access" }
    ],
    is_popular: true
  }
];
        ...
        {loading ? (
          ...
          <div className="text-center py-5">
            ...
            <Button 
              variant="outline" 
              onClick={retryFetch} 
              className="mb-4 bg-beach-50 border-beach-200 text-beach-700 hover:bg-beach-100"
            >
