...
const viTranslations: Record<TranslationKey, string> = {
  ...
  amenities_subtitle: "Không cần hào nhoáng, AnNam chăm chút từng điều bé xíu - vì sự tử tế đôi khi chỉ là: bạn chẳng phải lo gì cả trong suốt chuyến nghỉ của mình",
