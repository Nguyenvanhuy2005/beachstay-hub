      ...
      <section className="py-16 md:py-24 bg-beach-50">
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            <h2 className="font-display text-3xl mb-6 text-beach-900 font-extrabold">
              {language === 'vi' ? 'Đội Ngũ Quản Lý' : 'Management Team'}
            </h2>
            <p className="text-beach-800 max-w-3xl mx-auto font-normal">
              {language === 'vi' ? 'Gặp gỡ những người đứng sau sự thành công của Annam Village.' : 'Meet the people behind the success of Annam Village.'}
            </p>
          </motion.div>
