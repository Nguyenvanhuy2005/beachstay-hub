            ...
            >
              {language === 'vi' ? (
                <>
                  ...
                  <p className="mb-6">
                    Chào mừng bạn đến với An Nam Village. Khi truy cập và sử dụng trang web của chúng tôi, bạn đồng ý tuân thủ các điều khoản và điều kiện được nêu trong tài liệu này. Nếu bạn không đồng ý với bất kỳ phần nào của các điều khoản này, vui lòng không sử dụng trang web của chúng tôi.
                  </p>
                  
                  <h2 className="font-display text-2xl text-beach-800 mb-6">2. Đặt phòng và thanh toán</h2>
                  <p className="mb-6">
                    Khi đặt phòng tại An Nam Village, bạn đảm bảo rằng bạn đủ 18 tuổi trở lên và có đầy đủ thẩm quyền pháp lý để tham gia vào một hợp đồng ràng buộc. Bạn cũng đồng ý cung cấp thông tin thanh toán chính xác và đầy đủ.
                  </p>
                  <p className="mb-6">
                  ...
                  <p className="mb-6">
                    Khách có trách nhiệm đối với bất kỳ thiệt hại nào đối với tài sản resort do họ hoặc khách của họ gây ra. An Nam Village có quyền tính phí thẻ tín dụng đã đăng ký của khách để sửa chữa bất kỳ thiệt hại nào.
                  </p>
                  
                  <h2 className="font-display text-2xl text-beach-800 mb-6">5. Quyền và trách nhiệm của resort</h2>
                  <p className="mb-6">
                    An Nam Village có quyền từ chối phục vụ hoặc chấm dứt việc lưu trú của bất kỳ khách nào có hành vi sai trái, gây rối hoặc vi phạm các điều khoản và điều kiện của chúng tôi.
                  </p>
                  <p className="mb-6">
                ...
                <>
                  ...
                  <p className="mb-6">
                    Welcome to An Nam Village. By accessing and using our website, you agree to comply with the terms and conditions set out in this document. If you do not agree with any part of these terms, please do not use our website.
                  </p>
                  
                  <h2 className="font-display text-2xl text-beach-800 mb-6">2. Reservations and Payment</h2>
                  <p className="mb-6">
                    When making a reservation at An Nam Village, you warrant that you are at least 18 years of age and possess the legal authority to enter into a binding agreement. You also agree to provide accurate and complete payment information.
                  </p>
                  <p className="mb-6">
                  ...
                  <p className="mb-6">
                    Guests are responsible for any damage to resort property caused by themselves or their guests. An Nam Village reserves the right to charge the guest's registered credit card for the repair of any damages.
                  </p>
                  
                  <h2 className="font-display text-2xl text-beach-800 mb-6">5. Rights and Responsibilities of the Resort</h2>
                  <p className="mb-6">
                    An Nam Village reserves the right to refuse service or terminate the stay of any guest engaging in misconduct, causing disturbance, or violating our terms and conditions.
                  </p>
                  <p className="mb-6">
                  ...
                  <p className="mb-6">
                    An Nam Village reserves the right to modify or update these terms and conditions at any time. These changes will be effective immediately upon posting on our website. Your continued use of the website following such changes will constitute your acceptance of the modified terms.
                  </p>
                  
                  <h2 className="font-display text-2xl text-beach-800 mb-6">7. Contact Us</h2>
                  <p className="mb-6">
                    If you have any questions about our Terms of Use, please contact us via email at info@An Namvillage.vn or by phone at +84 909 123 456.
                  </p>
                </>
              )}
            </motion.div>
