                  ...
                  <Card className="overflow-hidden h-full flex flex-col hover:shadow-md transition-shadow">
                    ...
                    <CardContent className="py-6 flex-grow flex flex-col">
                      ...
                      <div className="text-beach-700 mb-4 flex-grow">
                        ...
                        {getRoomDescription(room).length > 150 && <button onClick={() => toggleDescription(room.id)} className="text-beach-600 font-medium mt-2 text-sm flex items-center hover:underline">
