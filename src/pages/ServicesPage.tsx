...
const ServicesPage = () => {
  ...
  const services = [{
    ...
    description: language === 'vi' ? 'Thưởng thức ẩm thực đa dạng tại nhà hàng và quầy bar của chúng tôi, hoặc tận hưởng dịch vụ ăn uống tại phòng 24/7.' : 'Enjoy diverse cuisine at our restaurant and bar, or enjoy 24/7 in-room dining service.'
  }, {
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            once: true
              ...
              <img src="/lovable-uploads/cdfb47b1-e949-44cc-85b1-de98fba2961e.png" alt={language === 'vi' ? 'Dịch Vụ Ẩm Thực' : 'Dining Services'} className="rounded-lg shadow-xl w-full h-auto object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
